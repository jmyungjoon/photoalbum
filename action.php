...
if(isset($_POST["action"]))
{
 ...
 {
  $folder = array_filter(glob('assets/img/*'), 'is_dir');
 ...
 {
    $fName = "assets/img/".$_POST["folder_name"];
 ...
 if($_POST["action"] == "fetch_files")
 {
  ...
  foreach($file_data as $file)
  {
   ...
   else
   {
    ...
    $output .= '
        <div class="col-lg-3 col-md-2 text-center portfolio-item filter-david" data-aos="fade-up">
            <div class="portfolio-wrap">
                <img src="'.$path.'" id="the-img" class="img-thumbnail" alt="">
                <div class="portfolio-info">
                    <div class="portfolio-links"  style="display: inline">
                        <a href="'.$path.'" data-gall="portfolioGallery" id="original" class="venobox vbox-item" title="Original"><i class="bx bx-plus" style="margin-top:10px"></i></a>
                        <input type="button" src="'.$path.'" id="the-img1" class="btn btn-primary btn-sm" value="Map" style="margin-bottom: 15px" >
                    </div>
                </div>
            </div>
            <button name="remove_file" class="remove_file btn btn-danger btn-sm" id="'.$path.'" style="margin-top : 10px">Remove</button>
        </div>
